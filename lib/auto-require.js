 ...
 * @param {import("make-module-env").ModuleEnv} env the module env to require from
 * @param {string} globalName The global we're trying to access
 * @returns {typeof EMPTY | any}
 */
